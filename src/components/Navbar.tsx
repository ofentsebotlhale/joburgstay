...
export default function Navbar({
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-blue-900/20 backdrop-blur-xl border-b border-slate-700/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2">
            <Home className="w-8 h-8 text-blue-400" />
            <div className="flex flex-col">
              <span className="text-white font-bold text-lg sm:text-sm leading-tight">
                Blue Haven
              </span>
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <span className="sm:text-sm">Book Now</span>
            </button>
          </div>
        </div>
      </div>
